...
public final class AnimUtils{
     ...
     * @return 一个透明度渐变动画
     */
    public static AlphaAnimation getAlphaAnimation(float fromAlpha, float toAlpha, long durationMillis,boolean fillAfter, Animation.AnimationListener animationListener) {
     ...
     * @return 一个透明度渐变动画
     */
    public static AlphaAnimation getAlphaAnimation(float fromAlpha, float toAlpha, boolean fillAfter,long durationMillis) {
        return getAlphaAnimation(fromAlpha, toAlpha,durationMillis,  fillAfter,null);
    }
     ...
     */
    public static AlphaAnimation getAlphaAnimation(float fromAlpha, float toAlpha, boolean fillAfter,Animation.AnimationListener animationListener) {
        return getAlphaAnimation(fromAlpha, toAlpha, DEFAULT_ANIMATION_DURATION, fillAfter, animationListener);
    }
     ...
     * @return 一个透明度渐变动画，默认持续时间为DEFAULT_ANIMATION_DURATION
     */
    public static AlphaAnimation getAlphaAnimation(float fromAlpha, float toAlpha,boolean fillAfter) {
        return getAlphaAnimation(fromAlpha, toAlpha, DEFAULT_ANIMATION_DURATION, fillAfter, null);
    }
     ...
     */
    public static AlphaAnimation getHiddenAlphaAnimation(long durationMillis, boolean fillAfter,Animation.AnimationListener animationListener) {
        return getAlphaAnimation(1.0f, 0.0f, durationMillis, fillAfter, animationListener);
    }
     ...
     * @return 一个由完全显示变为不可见的透明度渐变动画
     */
    public static AlphaAnimation getHiddenAlphaAnimation(long durationMillis,boolean  fillAfter) {
        return getHiddenAlphaAnimation(durationMillis,  fillAfter,null);
    }
     ...
     */
    public static AlphaAnimation getHiddenAlphaAnimation(boolean  fillAfter,Animation.AnimationListener animationListener) {
        return getHiddenAlphaAnimation(DEFAULT_ANIMATION_DURATION,fillAfter, animationListener);
    }
     ...
     * @return 一个由完全显示变为不可见的透明度渐变动画，默认持续时间为DEFAULT_ANIMATION_DURATION
     */
    public static AlphaAnimation getHiddenAlphaAnimation(boolean  fillAfter) {
        return getHiddenAlphaAnimation(DEFAULT_ANIMATION_DURATION, fillAfter, null);
    }
     ...
     */
    public static AlphaAnimation getShowAlphaAnimation(long durationMillis,boolean fillAfter, Animation.AnimationListener animationListener) {
        return getAlphaAnimation(0.0f, 1.0f, durationMillis,fillAfter, animationListener);
    }
     ...
     * @return 一个由不可见变为完全显示的透明度渐变动画
     */
    public static AlphaAnimation getShowAlphaAnimation(long durationMillis,boolean  fillAfter) {
        return getAlphaAnimation(0.0f, 1.0f, durationMillis, fillAfter, null);
    }
     ...
     */
    public static AlphaAnimation getShowAlphaAnimation(boolean  fillAfter,Animation.AnimationListener animationListener) {
        return getAlphaAnimation(0.0f, 1.0f, DEFAULT_ANIMATION_DURATION,  fillAfter,animationListener);
    }
     ...
     * @return 一个由不可见变为完全显示的透明度渐变动画，默认持续时间为DEFAULT_ANIMATION_DURATION
     */
    public static AlphaAnimation getShowAlphaAnimation(boolean  fillAfter) {
        return getAlphaAnimation(0.0f, 1.0f, DEFAULT_ANIMATION_DURATION,fillAfter, null);
    }
    ...
    public Animation getAnimation(Context context, int anim){
