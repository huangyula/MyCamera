...
static Mutex sLock;
static const char * const RETRIEVER_CLASS_NAME = "com/hiar/media/CainMediaMetadataRetriever";
...
static int register_com_hiar_media_CainMediaMetadataRetriever(JNIEnv *env) {
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    if (register_com_hiar_media_CainMediaMetadataRetriever(env) != JNI_OK) {
        return -1;
    }
