...
const char *CLASS_NAME = "com/hiar/media/CainMediaPlayer";
...
static int register_com_hiar_media_CainMediaPlayer(JNIEnv *env) {
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    if (register_com_hiar_media_CainMediaPlayer(env) != JNI_OK) {
        return -1;
    }
