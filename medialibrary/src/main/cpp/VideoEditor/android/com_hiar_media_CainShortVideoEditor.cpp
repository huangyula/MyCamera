...
static Mutex sLock;
static const char * const EDITOR_CLASS_NAME = "com/hiar/media/CainShortVideoEditor";
...
JNIShortVideoEditorListener::JNIShortVideoEditorListener(JNIEnv *env, jobject thiz,
    ...
    if (clazz == NULL) {
        ALOGE("Can't find com/hiar/media/CainMediaPlayer");
...
static int register_com_hiar_media_CainShortVideoEditor(JNIEnv *env) {
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    if (register_com_hiar_media_CainShortVideoEditor(env) != JNI_OK) {
        return -1;
    }
